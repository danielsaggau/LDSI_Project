...
def main(unused_argv):
    ...
    if FLAGS.per_host_test_bsz > 0:
        corpus.convert_to_tfrecords("test", save_dir, FLAGS.per_host_test_bsz, FLAGS.tgt_len, FLAGS.num_core_per_host,
                                    FLAGS=FLAGS)
        return
...
if __name__ == "__main__":
    ...
    flags.DEFINE_enum("dataset", "cdata", ["ptb", "wt2", "wt103", "lm1b", "enwik8", "text8", "cdata"],
                      help="Dataset name.")
    ...
    flags.DEFINE_integer("per_host_test_bsz", 0,
                         help="If > 0, enter test mode and process test set only. Otherwise, process train and dev sets only.")
